...
-- ----------------------------
BEGIN;
INSERT INTO `auth_assignment` VALUES ('Admin', '1', '1441532303'), ('Author', '3', '1441532303'), ('Management', '2', '1441532303');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_item` VALUES ('Admin', '1', 'สำหรับการดูแลระบบ', null, null, '1441532303', '1441532303'), ('Author', '1', 'การเขียนบทความ', null, null, '1441532303', '1441532303'), ('createBlog', '2', 'สร้าง blog', null, null, '1441532303', '1441532303'), ('loginToBackend', '2', 'ล็อกอินเข้าใช้งานส่วน backend', null, null, '1441532303', '1441532303'), ('Management', '1', 'จัดการข้อมูลผู้ใช้งานและบทความ', null, null, '1441532303', '1441532303'), ('ManageUser', '1', 'จัดการข้อมูลผู้ใช้งาน', null, null, '1441532303', '1441532303'), ('updateBlog', '2', 'แก้ไข blog', null, null, '1441532303', '1441532303'), ('updateOwnPost', '2', 'แก้ไขบทความตัวเอง', 'isAuthor', null, '1441532303', '1441532303');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_rule` VALUES ('isAuthor', 'O:22:\"common\\rbac\\AuthorRule\":3:{s:4:\"name\";s:8:\"isAuthor\";s:9:\"createdAt\";i:1441532303;s:9:\"updatedAt\";i:1441532303;}', '1441532303', '1441532303');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `migration` VALUES ('m000000_000000_base', '1440129630'), ('m130524_201442_init', '1440141419'), ('m140506_102106_rbac_init', '1440129925'), ('m150824_122129_rbac', '1441528375');
COMMIT;
